        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.contentContainer}>
                <View style={styles.header}>
                    <Text style={styles.appTitle}>Bus Driver App</Text>
                    <Text style={styles.subtitle}>Secure Ticketing System</Text>
                </View>

                <View style={styles.form}>
                    <Text style={styles.title}>Welcome Back</Text>
                    <Text style={styles.instruction}>Sign in to manage trips and verify tickets</Text>
